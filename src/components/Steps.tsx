...
const steps = [
    {
        title: 'Describe infra',
        text: 'YAML or UI. Define services, networks, security, storage.',
    },
    {
        title: 'Connect Git & cloud',
    ...
    {
        title: 'Track & rollback',
        text: 'Full audit trail, history, environment cloning.',
    },
];

export const Steps = () => {
    return (
        <section className="py-5 bg-light" id="flow">
            <div className="container">
                <h2 className="fw-bold mb-4">From idea to cloud</h2>
